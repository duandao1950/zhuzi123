...
<form action="asset_update.action?method=update" method="POST" enctype="multipart/form-data"/>
...
<TABLE border="0" width="50%">
    ...
    <TR>
		<TD class="tablebody"><s:text name="asset.page.id"/></TD>
		<TD>
			<input type="text" name="id" value="${asset_obj.id}" maxlength="10" readonly="readonly">
		</TD>
	</TR>
    <TR>
		<TD class="tablebody"><s:text name="asset.page.staff.id"/></TD>
		<TD>
			<input type="text" id="staffId" name="staffId" value="${asset_obj.staffId}" maxlength="10" readonly="readonly">
			<a href="javascript:selectStaff()">Lookup</a>
		</TD>
	</TR>
	<TR>
		<TD class="tablebody"><s:text name="asset.page.device.no"/></TD>
		<TD><input type="text" name="deviceNo" value="${asset_obj.deviceNo}" maxlength="32" >
		&nbsp;<font color="#C10202">*</font></TD>
	</TR>
	
	<TR>
		<TD class="tablebody"><s:text name="asset.page.com.display.no"/></TD>
		<TD><input type="text" name="comDisplayNo" value="${asset_obj.comDisplayNo}" maxlength="32">
		&nbsp;<font color="#C10202">*</font></TD>
	</TR>
	
	<TR>
		<TD class="tablebody"><s:text name="asset.page.com.host.no"/></TD>
		<TD><input type="text" name="comHostNo" value="${asset_obj.comHostNo}" maxlength="32">
		&nbsp;<font color="#C10202">*</font></TD>
	</TR>
	...
	<TR>
		...
		<TD>
		<select name="status">
			<option value="0" ${asset_obj.status == 0 ? 'selected':'' }>闲置</option>
			<option value="1" ${asset_obj.status == 1 ? 'selected':'' }>使用中</option>
		</select>
		</TD>
	</TR>
	...
	<TR>
		...
		<TD><input type="text" name="ipAddress" value="${asset_obj.ipAddress}" maxlength="32"></TD>
	</TR>
	
	<TR>
		<TD class="tablebody"><s:text name="asset.page.device.address"/></TD>
		<TD><input type="text" name="deviceAddress" value="${asset_obj.deviceAddress}" maxlength="32">
		&nbsp;<font color="#C10202">*</font></TD>
	</TR>
	
	<TR>
		<TD class="tablebody"><s:text name="asset.page.remark"/></TD>
		<TD><input type="text" name="remark" value="${asset_obj.remark}" maxlength="128"></TD>
	</TR>
